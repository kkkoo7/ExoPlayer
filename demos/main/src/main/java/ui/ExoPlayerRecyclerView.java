...
import utils.VideoPlayerConfig;
...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo() {
        ...
        String userAgent = Util.getUserAgent(appContext, "DemoApplication");
        //2

        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(appContext,
                Util.getUserAgent(appContext, "DemoApplication"), defaultBandwidthMeter);
        // This is the MediaSource representing the media to be played.
        String uriString = videoInfoList.get(targetPosition).getmUrl();
        if (uriString != null) {
    ...
    private List<StreamKey> getOfflineStreamKeys(Uri uri) {
        return ((DemoApplication) appContext).getDownloadTracker().getOfflineStreamKeys(uri);
    }
